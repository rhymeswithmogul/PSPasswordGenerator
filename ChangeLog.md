...
- Add an invisible `-Force` parameter.  It does nothing except prevent people who type `-AsPlainText -Force` (as you're forced to do with `ConvertTo-SecureString`) from causing an error.
